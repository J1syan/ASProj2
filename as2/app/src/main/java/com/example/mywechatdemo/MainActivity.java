...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragment1 = new WeChatFragment();
        fragment2 = new AddressBookFragment();
    ...
    private void initial() {
        ...
        FragmentTransaction transaction = manager.beginTransaction()
                .add(R.id.textView5, fragment1)
                .add(R.id.textView5, fragment2)
                .add(R.id.textView5, fragment3)
                .add(R.id.textView5, fragment4);
        transaction.commit();
    }
    ...
    private void select(int i) {//点击后改变对应页面显示,以及将对应的底部导航栏改为变色,图片与字体变绿
        ...
        switch (i) {
            ...
            case 2:
                ...
                break;
            case 3:
                imageView3.setImageResource(R.drawable.fx_press);
